...
<table style="border: 2px; text-align:center;">
  ...
  <tr>
    ...
    <td>
      <img src="./exec/img/가족코드공유.gif" alt="=" width="200px" />
    </td>
    <td>
...
<table style="border: 2px; text-align:center;">
  ...
  <tr>
   <td>
 <img src="./exec/img/가족상태조회.gif" alt="=" width="200px" />
    </td>
    <td>
 <img src="./exec/img/꾸욱누르기.gif" alt="=" width="200px" />
    </td>
    <td> 
 <img src="./exec/img/메시지_전송.gif" alt="=" width="200px" />
    </td>
    <td> 
 <img src="./exec/img/메시지받기.gif" alt="=" width="200px" />
    </td>
  </tr>
</table>
...
<table style="border: 2px; text-align:center;">
  ...
  <tr>
   <td>
 <img src="./exec/img/소식등록.gif" alt="=" width="200px" />
    </td>
    <td>
 <img src="./exec/img/소식조회및반응등록.gif" alt="=" width="200px" />
    </td>
    <td> 
 <img src="./exec/img/애정메시지.gif" alt="=" width="200px" />
    </td>
    <td> 
...
<table style="border: 2px; text-align:center;">
  ...
  <tr>
   <td>
 <img src="./exec/img/민들레성장.gif" alt="=" width="200px" />
    </td>
    <td>
 <img src="./exec/img/민들레성장과정.gif" alt="=" width="200px" />
    </td>
    <td> 
 <img src="./exec/img/경험치내역.gif" alt="=" width="200px" />
    </td>
    <td> 
 <img src="./exec/img/보관된소식조회.gif" alt="=" width="200px" />
    </td>
  </tr>
</table>
